...
class Classes extends MY_Controller
{
	...
	public function showAllStage()
	{
		...
		$mission = $this->classes_mission->jsonDecode($original['mission']['homework']);
		$personal = $this->classes_mission->jsonDecode($original['personal']['homework']);
		print_r(json_decode('[{"Video Learning":[9,10,11,8],"Article learning":[1,2,3,4]},{"Video learning":[1,2],"Article learning":[1,2],"Place your order":1,"4 style trade":4,"take profits\/stop loss":2},{"Make Transactions":20,"Trade all kinds products":15,"Trading Record":1,"Learning Report":1}]', true));die;
