...
class Trading_Analysis extends MY_Controller
{
	public function calculator_anytime()
	{
		...
		$data['data']['operating_accuracy'] = $this->trading_datas_calculate->build($mt4)->count()->property('accuracy', ['profit'])->get_property();
		$data['data']['trading_ability'] = $this->trading_datas_calculate->build($mt4)->count()->property('ability', ['profit'])->get_property() * 100;
