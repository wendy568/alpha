...
<script>
    ...
    import zonep_form from './Zonep_form'
    export default {
        data() {
            return {
                models: [
                ...
                .zp-model{
                    ...
                    .zp-model-item{
                        ...
                        .zp-model-item-icon{
                            ...
                            width: 100px;
                            height: 100px;
                            .zp-model-item-icon-img{
                                background-image: url(../assets/images/prop_icon.png);
                                background-size: 100%;
                                width: 100%;
                                height: 100%;
                                display: block;
                    ...
                    .zp-model-item:last-child{
                        .zp-model-item-icon-img{
                            background-image: url(../assets/images/algo_icon.png);
                            background-size: 100%;
                            width: 100%;
                            height: 100%;
                            display: block;
