        ...
        for(var i in stageDtail){
            ...
            switch (i.toLocaleLowerCase()){
                ...
                case 'article learning':getArticleList(stageDtail[index]);
                    ...
                    break;
                case 'place your order':setComplete(' .placeYourOrder');
                    break;
                case '4 style trade':setComplete(' .4StyleTrade');
                    break;
                case 'take profits/stop loss':setComplete(' .stopLoss');
                   break;
                case 'make transactions':setComplete(' .makeTransactions');
                    break;
                case 'trade all kinds products':setComplete(' .tradeAllKindsProducts');
                    break;
                case 'trading record':setComplete(' .tradingRecord');
                    break;
                case 'learning report':setComplete(' .learningReport');
                    break;
                case 'make transaction 1':setComplete(' .makeTransactionOn');
                    break;
                case 'make transaction 2':setComplete(' .makeTransactionTwo');
                    break;
                case 'task 1 - 2 different markets':setComplete(' .2DifferentMarkets');
                    break;
                case 'task 2 - 10 different products':setComplete(' .10DifferentProducts');
                    break;
                case '5 tradable products':setComplete(' .5TradableProducts');
                    break;
                case 'produce a module':setComplete(' .produceAModule');
                    break;
                case 'risk management level':setComplete(' .riskManagementLevel');
                    break;
                case 'trading score':setComplete(' .tradingScore');
                    break;
                case 'profitable period':setComplete(' .profitablePeriod');
                    break;
            }
        }
    }
