<template>
	<div class="order-box">
		<div ref="pay_deal" v-if="show_pay_deal" class="pay-deal-mask">
			<div class="pay-deal">
				Processing…………
			</div>
		</div>
		<div class="order-header">
			<span id="order-act" class="order-title" @click="toggleOrder($event)" :class="{ 'order-title-label-hover': show_act }">
				Activity order
			</span>
			<span id="order-z" class="order-title-label" @click="toggleOrder($event)" :class="{ 'order-title-label-hover': show_z }">
				Zone order
			</span>
			<span id="order-zp" class="order-title-label" @click="toggleOrder($event)" :class="{ 'order-title-label-hover': show_zp }">
				Zone+ order
			</span>
